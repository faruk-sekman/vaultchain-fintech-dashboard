...
/**
 * Stage uses the same origin as the frontend deployment. This prevents calls to a third-party/demo
...
export const environment = {
  production: false,
  // Deployed build: no devtools / verbose logging even though `production` stays false (re-audit
  // op-stage-devtools). See environment.ts for the rationale.
