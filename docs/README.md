...
| --- | --- |
| **Evaluating in 60–90 seconds** | [Evaluator path](evaluator-path.md) → [Security proof map](security-proof-map.md) |
...
| [security-proof-map.md](security-proof-map.md) | Claim → control → test → file map for the security story. |
| [evaluator-path.md](evaluator-path.md) | A no-surprises 60–90 second tour for reviewers, including the GIF and Docker path. |
| [release-notes/v1.0.0.md](release-notes/v1.0.0.md) | Short body for the public GitHub `v1.0.0` release. |
| [roadmap-issues.md](roadmap-issues.md) | Three issue-ready roadmap drafts for the public repository. |
